...
[Miniconda](https://docs.conda.io/en/latest/miniconda.html) é uma versão compacta e gratuita do gerenciador de bibliotecas Conda. É uma versão reduzida do [Anaconda](https://www.anaconda.com/about-us) que inclui apenas Conda, Python, os pacotes dos quais eles dependem e alguns outros pacotes úteis, incluindo pip, zlib etc.
